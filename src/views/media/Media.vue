...
export default {
  ...
  methods: {
    ...
    openCroppFileModal(id){
        ...
        .then(function (response) {
            self.elementId = response.data.data.id
            self.croppUrl = response.data.data.url
    ...
    getFileInfo(id){
        ...
        axios.get(   this.$apiAdress + '/api/media/file?thisFolder=' + self.thisFolder + '&id=' + id + '&token=' + localStorage.getItem("api_token")
            ...
            self.fileInfo = [];
            self.fileInfo.push({name: 'Name'        , data: response.data.data['name']});
            self.fileInfo.push({name: 'Real name'   , data: response.data.data['realName']});
            self.fileInfo.push({name: 'URL'         , data: response.data.data['url']});
            self.fileInfo.push({name: 'Mime Type'   , data: response.data.data['mimeType']});
            self.fileInfo.push({name: 'Size'        , data: response.data.data['size']});
            self.fileInfo.push({name: 'Created At'  , data: response.data.data['createdAt']});
            self.fileInfo.push({name: 'Updated At'  , data: response.data.data['updatedAt']});
        })
        .catch(function(error){
            console.log(error)
            self.$router.push({ path: '/login' })
    ...
    getFoldersAndFiles(folderId){
        ...
        .then(function (response) {
            self.medias         = response.data.data.medias
            self.mediaFolders   = response.data.data.mediaFolders
            self.thisFolder     = response.data.data.thisFolder
            self.parentFolder   = response.data.data.parentFolder
            self.buildItems()
            self.rightCard = 'fileInfo'
        }).catch(function (error) {
            console.log(error)
