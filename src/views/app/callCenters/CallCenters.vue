    ...
    <CCol col="12" >
      ...
      <CCard>
        ...
        <CCardBody>
          ...
          <template #show="{item}">
            <td>
              <CButton color="primary" @click="showCallCenter( item.key )">Show</CButton>
            </td>
          </template>
          <template #edit="{item}">
            <td>
              <CButton color="primary" @click="editCallCenter( item.key )">Edit</CButton>
            </td>
          </template>
          <template #delete="{item}">
            <td>
              <CButton v-if="you!=item.key" color="danger" @click="deleteCallCenter( item.key )">Delete</CButton>
            </td>
          </template>
        </CDataTable>
        </CCardBody>
