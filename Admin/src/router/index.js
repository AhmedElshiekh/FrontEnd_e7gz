...
const BookAppointment = () => import('@/views/app/appointments/BookAppointment')

// reports 
const reportsCallcenters = () => import('@/views/app/reports/callCenters/reportsCallcenters')
const reportsCallcenterDetails = () => import('@/views/app/reports/callCenters/reportsCallcenterDetails')

const reportsDoctors = () => import('@/views/app/reports/doctors/reportsDoctors')
const reportsDoctorDetails = () => import('@/views/app/reports/doctors/reportsDoctorDetails')
  ...
  return [
    {
      ...
      children: [
        ...
        //Appointments route - directory
        {
          path: 'reportsCallcenters',
          meta: { label: 'reportsCallcenters'},
          component: {
            render (c) { return c('router-view') }
          },
          children: [
            {
              path: '',
              component: reportsCallcenters,
              
            },
            {
              path: ':id/details',
              meta: { label: 'Details reports CallCenter' },
              name: 'Details reports CallCenter',
              component: reportsCallcenterDetails,
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: ':id/:month/details',
              meta: { label: 'Details Reports Doctor' },
              name: 'Details Reports Doctor',
